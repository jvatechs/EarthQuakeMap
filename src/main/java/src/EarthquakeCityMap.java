...
public class EarthquakeCityMap extends PApplet {
    private static final String EARTHQUAKES_URL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/2.5_week.atom";
    private static final String CITY_FILE = "cities.geo.json";
    private static final String COUNTRY_FILE = "custom.geo.json";
    ...
    public void setup() {
        ...
        List<Feature> countries = GeoJSONReader.loadData(this, COUNTRY_FILE);
        countryMarkers = MapUtils.createSimpleMarkers(countries);

        //     STEP 2: read in city data
        List<Feature> cities = GeoJSONReader.loadData(this, CITY_FILE);
        ...
        List<PointFeature> earthquakes = ParseFeed.parseEarthquake(this, EARTHQUAKES_URL);
